...
public:
	...
	inline const ci::vec3& setTranslation() const { return mTransformation.getTranslation(); }
	...
	inline const ci::mat4& getModelMatrix() const { return mTransformation.getModelMatrix(); }
